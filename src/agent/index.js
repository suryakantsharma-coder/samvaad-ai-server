...
const { getHospitalInstructions, DEFAULT_INSTRUCTIONS } = require('./hospitalInstructions');
...
// getHospitalInstructions and DEFAULT_INSTRUCTIONS are from ./hospitalInstructions (shared with gemini-realtime).
...
// =========================
// Gemini Realtime route (human + Hindi detection once)
// =========================
const { attachGeminiRoutes } = require('./gemini-realtime');
...
app.get('/', (req, res) => {
  res.send(
    'Chat-bot Voice Agent (Exotel + OpenAI Realtime). Connect to /media/:hospitalId or /media-gemini/:hospitalId via WebSocket.',
  );
});
...
// Export for use by gemini-realtime.js
module.exports = { startAgent, getHospitalInstructions };
