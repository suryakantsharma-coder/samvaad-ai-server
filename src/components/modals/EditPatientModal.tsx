...
export const EditPatientModal = ({
  ...
  const { handleUpdatePatient } = usePatient();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[600px] w-[90vw] p-0 gap-0 rounded-[10px]">
        <div className="flex items-center gap-4 px-5 py-4 bg-grey-light">
          <UserIcon className="w-6 h-6" />
          <DialogTitle className="font-title-3m font-[number:var(--title-3m-font-weight)] text-black text-[length:var(--title-3m-font-size)] tracking-[var(--title-3m-letter-spacing)] leading-[var(--title-3m-line-height)] [font-style:var(--title-3m-font-style)]">
            Edit Information
          </DialogTitle>
        </div>
