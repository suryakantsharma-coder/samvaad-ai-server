 ...
 * Returns patient details, all appointments, and all prescriptions for the patient.
 */
const getOverview = async (req, res, next) => {
  try {
    const patientId = req.params.id;
    const patientQuery = { _id: patientId };
    mergeHospitalFilter(req, patientQuery);
    ...
    const aptFilter = { patient: patientId };
    const rxFilter = { patient: patientId };
    mergeHospitalFilter(req, aptFilter);
