...
const SparklineUp = () => (
  <svg viewBox="0 0 49 50" fill="none" className="w-[49px] h-[50px]">
    <polyline points="0,40 10,30 20,35 30,20 40,25 49,10" stroke="#009598" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
    <polyline points="0,40 10,30 20,35 30,20 40,25 49,10 49,50 0,50" fill="#009598" fillOpacity="0.1" />
  </svg>
);

const SparklineRing = () => (
  <svg viewBox="0 0 50 50" className="w-[50px] h-[50px]">
    <circle cx="25" cy="25" r="20" fill="none" stroke="#e0f5f5" strokeWidth="6" />
    <circle cx="25" cy="25" r="20" fill="none" stroke="#009598" strokeWidth="6"
      strokeDasharray="75 51" strokeLinecap="round" transform="rotate(-90 25 25)" />
    <circle cx="25" cy="25" r="12" fill="none" stroke="#bfe6e7" strokeWidth="4"
      strokeDasharray="50 26" strokeLinecap="round" transform="rotate(-90 25 25)" />
  </svg>
);
...
const SparklineBar = () => (
  <svg viewBox="0 0 59 49" fill="none" className="w-[59px] h-[49px]">
    {[
      { x: 2, h: 20 }, { x: 12, h: 32 }, { x: 22, h: 25 },
      { x: 32, h: 38 }, { x: 42, h: 30 }, { x: 52, h: 42 },
    ].map((bar, i) => (
      <rect key={i} x={bar.x} y={49 - bar.h} width="7" height={bar.h}
        rx="3" fill={i === 5 ? "#009598" : "#bfe6e7"} />
    ))}
  </svg>
);
                    ...
                    <div className="absolute top-[72px] left-5 right-[6.75rem] flex min-w-0 flex-col items-stretch gap-[5px]">
                      ...
                      <div className="flex min-w-0 items-center gap-[5px]">
                        <div className="inline-flex shrink-0 items-center gap-[5px]">
                          <TrendingUp className="w-4 h-4 text-[#00955b]" strokeWidth={2} />
