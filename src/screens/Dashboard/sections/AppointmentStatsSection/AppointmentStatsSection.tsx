...
export const AppointmentStatsSection = (): JSX.Element => {
  ...
  return (
    <Card className="flex h-[375px] w-full flex-col overflow-hidden rounded-[10px] border-0 bg-white shadow-[0px_2px_6px_#a2a6b040]">
      <CardContent className="flex min-h-0 flex-1 flex-col p-0">
        <div className="mb-2.5 flex h-8 shrink-0 items-center justify-between px-5 pb-0 pt-5">
        ...
        <div className="mt-2.5 flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden">
          {doctors.map((doctor) => (
            <div
              key={doctor.id}
              className="flex flex-col gap-2.5 px-5 py-0 w-full"
            >
